...
const APP_CONFIG = {
  ...
  // 企業理念（ホームの「今日の理念」と理念ページで使う）
  philosophy: {
    corporateName: '株式会社AHL',
    philosophy: 'Alusheに携わる人を好きになり幸せにする',
    vision: '日本一幸福度の高い企業グループ（幸福度No.1企業）',
    value: '遊びのように仕事をし美容を楽しむ！',
    nameOrigin: '社名の「AHL」は「Alushe Happy Love」（アルーシェ ハッピー ラブ）に由来します。スタッフやその家族、お客様など、アルーシェに携わるすべての人を喜ばせ、幸せにしたいという想いが込められています。',
    // ホームに日替わりで表示する言葉（日付の順に切り替わる。増やす場合はここに追加）
    dailyQuotes: [
      'Alusheに携わる人を好きになり幸せにする',
      '日本一幸福度の高い企業グループ',
      '遊びのように仕事をし美容を楽しむ！',
      'Alushe Happy Love',
    ],
